                ...
                <div className="flex w-[95%] h-18 flex-row justify-between items-center ">
                   <div className='flex flex-row justify-center gap-4 bg-transparent'>
                    ...
                    <div className="w-50 h-12 flex justify-center items-center gap-2 ml-15">
                        <span className="flex justify-center gap-2 cursor-pointer hover:bg-white/30 duration-300 transition-all hover:duration-300 items-center bg-white/10  backdrop-blur-xl w-27 h-10  text-center  rounded-full">
